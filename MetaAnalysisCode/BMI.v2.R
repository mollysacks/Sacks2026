...
dir.create('BMI.v2')
dir.create('BMI.v2/fixed_effects')
dir.create('BMI.v2/random_effects')
dir.create('BMI.v2/raw_quantiles')
dir.create('BMI.v2/scaled_quantiles')
dir.create('BMI.v2/tables')
...
for(i in seq_along(cohorts_all)){
  ...
  table <- read.csv(paste0('Inputs_v2/', cohort, '/BMI/AnalysisOutput/', out_string))
  table$cohort <- cohort
...
write.csv(table_all, paste0('BMI.v2/tables/', out_string))
write.csv(fixed_effects, paste0('BMI.v2/fixed_effects/', out_string))
write.csv(random_effects, paste0('BMI.v2/random_effects/', out_string))
write.csv(quantiles_raw, paste0('BMI.v2/raw_quantiles/', out_string))
write.csv(quantiles_scaled, paste0('BMI.v2/scaled_quantiles/', out_string))
...
write.csv(table_all, paste0('BMI.v2/tables/', '2b_CNV_main_effect.csv'))
write.csv(fixed_effects, paste0('BMI.v2/fixed_effects/', '2b_CNV_main_effect.csv'))
write.csv(random_effects, paste0('BMI.v2/random_effects/', '2b_CNV_main_effect.csv'))
...
dir.create('BMI/fixed_effects/27_variance_explained')
dir.create('BMI/random_effects/27_variance_explained')
dir.create('BMI/tables/27_variance_explained')
...
for(j in seq_along(models)){
  ...
  for(i in seq_along(cohorts)){
    ...
    anova_df <- read.csv(paste0('Inputs_v2/', cohort, '/BMI/AnalysisOutput/14_variance_explained/', model))
...
write.csv(anova_all, 'BMI.v2/tables/14_variance_explained.csv')
write.csv(anova_fixed, 'BMI.v2/fixed_effects/14_variance_explained.csv')
write.csv(anova_random, 'BMI.v2/random_effects/14_variance_explained.csv')
...
for(i in seq_along(cohorts)){
  cohort <- cohorts[i]
  lines <- readLines(paste0('Inputs_v2/', cohort, '/BMI/AnalysisOutput/', out_string))
  for(line in lines){
...
write.csv(table_all, paste0('BMI.v2/tables/', out_string))
write.csv(lTest_out, paste0('BMI.v2/fixed_effects/', out_string))
